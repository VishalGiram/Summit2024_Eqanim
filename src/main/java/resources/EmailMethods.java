...
public class EmailMethods {
	...
	public void mail() throws InterruptedException {
		...
		final String to = "vishal.giram@eqanim.com, padmakar.mohire@eqanim.com, vikram.kankure@eqanim.com, tushar@eqanim.com";
		final String cc = " ";
		...
		try {
			...
			String file1 = "C://Users//Geeta//eclipse-workspace//Auction_Automation2//reports//index.html"; // change
